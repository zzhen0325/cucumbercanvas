...
interface CanvasBottomBarProps {
  ...
  filesOpen: boolean;
  onToggleFiles: () => void;
  /** Whether any left panel (layers/files) is open — shifts the utility bar right */
  leftPanelOpen: boolean;
  traceRecordingEnabled: boolean;
  onToggleTraceRecording: () => void;
  onClearTrace: () => void;
}
...
const TraceIcon = ({ className }: { className?: string }) => (
  <Ico className={className} vb="0 0 20 20">
    <path
      d="M4 5.25h4M12 5.25h4M8 5.25a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0Zm6.5 0a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0ZM10 14.75h4M4 14.75h4M8 14.75a1.25 1.25 0 1 0 2.5 0 1.25 1.25 0 0 0-2.5 0Zm6.5 0a1.25 1.25 0 1 0 2.5 0 1.25 1.25 0 0 0-2.5 0ZM10 5.25v9.5"
      stroke="currentColor"
      strokeWidth="1.4"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const TrashIcon = ({ className }: { className?: string }) => (
  <Ico className={className} vb="0 0 20 20">
    <path
      d="M5.5 6.5h9M8 3.75h4m-5.25 2.75.4 8.037c.03.61.533 1.088 1.143 1.088h3.414c.61 0 1.113-.478 1.143-1.088l.4-8.037M8.5 9v3.75M11.5 9v3.75"
      stroke="currentColor"
      strokeWidth="1.4"
      strokeLinecap="round"
      strokeLinejoin="round"
...
/* ── Toolbar button ── */
const btnClass =
  "flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-muted-foreground/75 transition-colors hover:bg-foreground/5 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1";
  ...
  return (
    ...
    >
      <div className="flex items-center gap-1">
        ...
        <button
          type="button"
          className={`${btnClass} ${layersOpen ? activeBtnClass : ""}`}
        ...
        <button
          type="button"
          className={`${btnClass} ${filesOpen ? activeBtnClass : ""}`}
        ...
        <button
          type="button"
          className={`${btnClass} ${traceRecordingEnabled ? activeBtnClass : ""}`}
        ...
        <button
          ref={zoomBtnRef}
          type="button"
          className="flex h-8 min-w-10 items-center justify-center rounded-lg px-1 text-center text-xs text-muted-foreground/75 transition-colors hover:bg-foreground/5 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1"
      ...
      <Popover
        ...
        className="w-65 rounded-2xl p-3"
      >
